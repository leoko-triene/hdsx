...
当前版本进一步提供可恢复的答疑会话与备课历史、多角色注册和家长多学生绑定、基于知识库的作业材料生成、薄弱知识画像、知识点图谱、课堂高频问题、教师修正 AI 回答、站内通知及家长友好学习报告。知识点图谱除 AI 自动生成外，课程负责人/管理员还可在图谱页面手动增删改知识点节点与关系边，修改后自动同步到最新图谱版本。教师可查看全部课程信息，但教学操作严格限制在其负责课程。
